...
<h6>예측 서비스</h6>
<img src="img/predict.gif" />
<ul>
    <li>각 대여소마다 향후 48시간의 잔여대수, 이용량을 예측하여 제공</li>
    <li>강수예보, 휴일, 온도 등 판단 근거가 되는 정보들을 표시</li>
    <li>너무 최근에 생겨 데이터가 부족한 대여소일 경우 예측서비스를 제공하지 않음</li>
    <li>지난 1주일간의 잔여대수, 상위 유입량, 유출량이 발생했던 때를 보여줌</li>
    <li>강수예보, 휴일, 온도 등 판단 근거가 되는 정보들을 표시</li>
</ul>
<br/><br/>
...
<ul>
    <li>정보수정 페이지</li>
    <li>유저 CRUD의 UD를 할 수 있음</li>
    <li>비밀번호를 두 번 입력한 후 프론트엔드와 백엔드에서 각각 검증</li>
</ul>
<br/><br/>
...
<ul>
    <li>각 모델에 대한 CRUD기능 구현</li>
    <li>일반적인 모델에 대한 table과 form을 구성하고 선택한 model의 field의 이름과 같은 메타정보를 백엔드에서 받아와 구현</li>
</ul>
<br/><br/>
