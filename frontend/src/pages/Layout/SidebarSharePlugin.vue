  ...
  <div class="fixed-plugin" v-click-outside="closeDropDown">
    <div class="dropdown show-dropdown" :class="{ show: isOpen }">
      ...
      <ul class="dropdown-menu" :class="{ show: isOpen }">
        <li class="header-title">{{this.$t('sidebar.sidebarColor')}}</li>
        ...
        <li class="header-title">{{this.$t('sidebar.darkMode')}}</li>
        <li class="adjustments-line">

          <div class="togglebutton switch-change-color">
            <span class="label-switch">LIGHT</span>
            <base-switch v-model="darkMode" @input="toggleMode"></base-switch>
            <span class="label-switch label-right">DARK</span>
          </div>
        </li>
      </ul>
      <div></div>
